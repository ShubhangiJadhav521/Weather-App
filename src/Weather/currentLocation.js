...
const CurrentLocation = (props) => {
  ...
  const getWeather = async (lat, lon) => {
    try {
        ...
        setCountry(data.sys.country);
          console.log("dflkfd",data.weather.main)
  ...
  return(
    <>
    <div className="bodylocation" style={{ backgroundColor: props.isBlackBackground ? 'white' : 'rgb(24, 24, 26)', color: props.isBlackBackground ?  'rgb(24, 24, 26)':'white' }}>
      {(temperatureC)?(<>
        ...
        <Forcast icon={icon} weather={description} city={city} setCity={setCity} setTemperatureC={setTemperatureC}/>
        </div></>):(<>
        <div className="container">
